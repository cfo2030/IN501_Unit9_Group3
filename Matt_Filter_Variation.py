# Matt's Variation of the baseline CNN Model
# Parameter changed: the number of filters in the first convolution layer
# This parameter detects visual patterns in the image such as lines, curves, and edges.
# Hypothesis: Increasing the number of filters should help the model learn more patterns and may slightly improve accuracy, but may also increase training time.
...
# Changed the number of filters from 32 to 64 for this variation
